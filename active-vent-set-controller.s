# open or close all network active vents depending on a vent command setting
# RespondToInternal should be changed if this active vent set is considered internal or external.
# intended use would have a memory / ic housing mirrored from a controlling network that wants to command two sets of multiple active vents.
